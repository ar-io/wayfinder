...
export const lucideIcons = {
  ...
  dice3:
    '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><path d="M16 8h.01"/><path d="M12 12h.01"/><path d="M8 16h.01"/></svg>',
  gitBranchPlus:
    '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m5 12 7-7"/><circle cx="5" cy="19" r="3"/><circle cx="19" cy="5" r="3"/><path d="M5 16v-1a2 2 0 0 1 2-2h6"/><path d="M16 8h3"/><path d="M17.5 6.5v3"/></svg>',
  shieldCheck:
  ...
  alertOctagon:
    '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="7.86 2 16.14 2 22 7.86 22 16.14 16.14 22 7.86 22 2 16.14 2 7.86 7.86 2"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>',
  siren:
...
/**
 * Create an icon element with optional size and color
 * @param {string} iconName - Name of the icon from lucideIcons
 * @param {Object} options - Options for the icon
 * @param {number} options.size - Size in pixels (default: 16)
 * @param {string} options.class - CSS class to apply
 * @param {string} options.color - Color for the stroke
 * @returns {string} HTML string of the icon
 */
export function createIcon(iconName, options = {}) {
  const { size = 16, class: className = '', color = 'currentColor' } = options;
  ...
  // Replace width, height, and stroke color in the SVG
  return icon
...
/**
 * Create an inline icon for use in text
 * @param {string} iconName - Name of the icon
 * @returns {string} HTML string of the inline icon
 */
export function inlineIcon(iconName) {
...
/**
 * Map of emoji to icon names for easy replacement
 */
